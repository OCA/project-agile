...
This module integrates ``project_git`` and ``project_agile`` modules by displaying commits on task details view under section ``Development``


Usage
=====

In order to see registered commits one needs to open a task in odoo agile and look from "Development" section on the form view.
