...
odoo.define('lira.view.kanban_table', function (require) {
    "use strict";
    ...
    class SwimlaneDefinition {
         ...
         */
        constructor(kanbanTable, field, text, undefinedHeaderName = _t("Undefined"), headerTemplate = "lira.kanban_table.swimlane.header.simple") {
            this.kanbanTable = kanbanTable;
            this.field = field;
            this.text = text;
            this.undefinedHeaderName = undefinedHeaderName;
            this.headerTemplate = headerTemplate;
            this.swimlaneNoHeaderTemplate = "lira.kanban_table.swimlane";
            this.swimlaneTemplate = "lira.kanban_table.swimlane.collapsible";
            this.columnTemplate = "lira.kanban_table.column";
        }
    ...
    class StorySwimlaneDefinition extends AsyncSwimlaneDefinition {
        constructor(kanbanTable) {
            super(kanbanTable, 'story', _t("User Story"), _t("Other issues"), "lira.kanban_table.swimlane.header.story");
        }
        ...
        header(task) {
            if (!task.parent_id) {
                ...
                header._overrideTemplate = "lira.kanban_table.swimlane.header.simple";
                return header;
            }
    ...
    var AbstractCard = BaseWidgets.AgileBaseWidget.extend(mixins.MenuItemsMixin, {
        _name: "AbstractCard",
        template: "lira.kanban_table.card",
    ...
    var TaskCard = AbstractCard.extend({
        ...
        customCardTitle: "lira.kanban_table.card.task.title",
        customCardFooter: "lira.kanban_table.card.task.footer",
        init(parent, options) {
            this._super(parent, options);
        ...
        image_url() {
            return this.user ? data.getImage("res.users", this.user.id, this.user.write_date) : "/lira/static/img/unassigned.png";
        },
        image_tooltip() {
    ...
    var AbstractKanbanTable = BaseWidgets.AgileBaseWidget.extend({
        ...
        init(parent, options) {
            ...
            this._require_prop("dataService", "An instance of implementation of DataService from lira.DataService module.");
    ...
    var AbstractKanbanTableView = BaseWidgets.AgileViewWidget.extend({
        ...
        template: "lira.view.kanban_table",
        emptyTitle: _t("No data in kanban table"),
        emptyTemplate: "lira.view.kanban_table.empty",
        init(parent, options) {
            Object.assign(this, options);
            this._super(parent, options);
        ...
        renderSettingsModal() {
            ...
            return qweb.render("lira.view.kanban_table.settings_modal", {swimlanes});
        },
        _getSwimlaneOptions() {
