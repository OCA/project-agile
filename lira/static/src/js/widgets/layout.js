...
odoo.define('lira.layout', function (require) {
    "use strict";
    ...
    var PageManager = require('lira.page_manager');

    var AgileContainerWidget = require('lira.BaseWidgets').AgileContainerWidget;
    var AgileHeader = require('lira.header');

    var AgileLayout = AgileContainerWidget.extend({
        template: "lira.layout",
        failTemplate: "lira.layout.fail",
        custom_events: {
            'menu.added': function () {
