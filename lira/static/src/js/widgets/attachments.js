...
odoo.define('lira.attachments', require => {
    "use strict";
    var BaseWidgets = require('lira.BaseWidgets');
    var AbstractModelList = require('lira.abstract_model_list');
    var dialog = require('lira.dialog');
    var _t = require('web.core')._t;

    const AttachmentsWidget = BaseWidgets.AgileBaseWidget.extend({
        template: "lira.attachments",
        multiple: true,
        convertTimeout: 3000,
        custom_events: {
    ...
    const AttachmentsItem = AbstractModelList.AbstractModelListItem.extend({
        template: "lira.attachments.item",
