...
class LiraController(http.Controller):
    ...
    @http.route('/lira/web/data/task/create_link', type='json', auth='user')
    ...
    def add_comment(self, task, comment):
        ...
        return new_message.with_context(lira=True).message_format()
    ...
    def edit_comment(self, task, message, comment):
        ...
        return message.with_context(lira=True).message_format()
    ...
    def confirm_task_stage_change(self, task, values, message=None):
        ...
        return msg and msg.with_context(lira=True).message_format() or False
