...
class ProjectScrumMeeting(models.Model):
    ...
    datetime_meeting = fields.Datetime(
        string="Date and Time of the meeting", required=True,
    )
    ...
    question_yesterday = fields.Html(string="Description", required=True,)
    question_today = fields.Html(string="Description", required=True,)
    question_blocks = fields.Html(string="Description", required=False,)
