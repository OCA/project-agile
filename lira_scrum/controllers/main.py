...
class LiraController(main.LiraController):
    ...
    @http.route('/lira/web/data/sprint/create', type='json', auth='user')
    ...
    @http.route([
        '/lira/web/data/active_sprints/<model("project.agile.board"):board>',
    ], type='json', auth='user')
    ...
    def prepare_task(self, task):
        task_data = super(LiraController, self).prepare_task(task)
        task_data.update({
    ...
    def prepare_user_team(self, team):
        result = super(LiraController, self).prepare_user_team(team)
