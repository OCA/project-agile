...
odoo.define('lira_scrum.view.backlog', function (require) {
    "use strict";
    ...
    const DataWidget = require('lira.BaseWidgets').DataWidget;
    ...
    const ScrumBacklogView = BacklogView.AbstractBacklogView.extend({
        ...
        loadDependencies() {
            return this._super().then(() => {
                ...
                // return data.xmlidToResId("lira.project_task_type_epic").then(epic_type_id => this.epic_type_id = epic_type_id);
            });
        ...
        _onStartSprint(evt) {
            ...
            dialog.confirm(_t("Start sprint"), _t("Are you sure you want to start this sprint?"), _t("yes")).done(() => {
                ...
                data.session.rpc(`/lira/web/data/sprint/${sprint.id}/start`, {
        ...
        _onEndSprint(evt) {
            ...
            dialog.confirm(_t("End sprint"), _t("Are you sure you want to end this sprint?"), _t("yes")).done(() => {
                data.session.rpc(`/lira/web/data/sprint/${sprint.id}/stop`);
            });
        },
        _onAddNewSprintClick() {
            ...
            data.session.rpc(`/lira/web/data/sprint/create/`, {'sprint': sprintData})
                .then(sprint => {
                    this.addSprint(sprint, true);
                })
                .fail(e => {
